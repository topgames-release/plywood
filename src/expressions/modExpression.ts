...
export class ModExpression extends ChainableUnaryExpression {
  static op = "Mod";
  static fromJS(parameters: ExpressionJS): ModExpression {
    return new ModExpression(ChainableUnaryExpression.jsToValue(parameters));
  }
  ...
  protected specialSimplify(): Expression {
    ...
    // X / 1
    if (this.expression.equals(Expression.ONE)) return Expression.ZERO;

    return this;
  }
}

Expression.register(ModExpression);
